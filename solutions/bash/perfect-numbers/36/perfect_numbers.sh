...
S1_Pn () {
  ...
  then
    ...
    # Avoid **2 for big primes
    #  => expand range ! Cf above [Hyp.0]
    if [[ $n -eq 2 ]] 
    then
      echo "$((P + 1))"
    else
...
# ...
#
# REM : This family of multiple variables functions
#       seems quite interesting, indeed !
#
# REM2 : Some considerations about combinations (sets)
#        wasnt included here.
# ...
#
...
#
# =======================================================
# NEXT : Make this a bc script to extend it with 
#        very bigger numbers !
#        
#  [th.1] needs Pⁿ⁺¹ value and sometimes it breaks
#    2⁶³-1 bash limitation (big primes!)
#      => wrong negatives.
#  ie many breaks happen in ranges ~     100000000000 :
#                                    7FFFFFFFFFFFFFFF
#                      2⁶³-1  =>  9223372036854775807
#  $ bc <<< "25000000111 ^2"  =>  625000005550000012321
#  $ echo $((25000000111**2)) => -2189292956124742623 
#
#  New limit ~ 5*10^18 !!!  ( few wrong negatives in results, 
#   (slightly modified  'S1_Pn')    though wrong positives? )
#
#  nb : Using 'for' loop for samples need a 'sleep .02'
#        in between to avoid some "no such file ..
#        .. or directory" errors ! :)
#
# [Hyp.0] : Around Sᵪ(N) +/- 10 there is 100% chances to 
#    find a prime number?! 
#  ( based on my empirical tests, 
#       more conditions are required.. )
#########################################################
