...
#               (2 functions for each SIN type)
#       1. strip spaces if any
#       2. browse every 2 chars in Input
#       3. for each char/digit (odds/US or pairs/CAN)
#           add its proper position value (x2 or x2 - 9)
#       4. add other "twin char" as is.
#	5. recurre to 2.
#       6. check validity mod 10
# End Maths
#
