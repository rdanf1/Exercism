...
#                 N=5870865 gives 59 "nearest" (N=⌉ρ₂₋₈)
#
# NB3_Ko: N=510510 gives "45 true pascal triangles" and 23 "near"
#     => Algorithm need checking results => may be longer ~10%/3M
#     BUT JUST KEEP IN MIND FALSE SOL. FOR FURTHER STUDIES !!!
#     My hypothesis : When *many* (true or false!) are found
#           Then N is componed of product of distinct primes^1
#           in other words we can assess that : N+1 is prime !!!
#
...
And a sample with a "nearly triangle-rectangle"
 when N is Odd !!! => Needs to comment Line 280 (& uncmt 282) !
$ time $0 2600005
...
mk_Sth () {
  ...
  # keep commented if testing "nears".. and/or Check<>1
  #    => Though Odds N may take longer to compute..
  [[ "$((N % 2 ))" -eq 1 ]] && exit 0
